...
#opt$input <- "C:/Users/miles/Documents/Resurrect_Bio/Scripts/rb_automation/cell_od_calculator/templates/csvs_250120/25.01.20_N2_EffectorPlate1.csv"
...
p1 <- ggplot(data = p1_melted, aes(x = Effector, y = as.numeric(value), colour = effector_num)) +
		geom_vline(xintercept = c(1, 8, 9, 16, 17, 24, 25, 32), linetype = "dashed", color = "grey40") +
